...
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      gcTime: 1000 * 60 * 60 * 8, // 8 hours — keep cached data for a full shift
    },
  },
});
...
const App = () => {
  ...
  return (
    <PersistQueryClientProvider client={queryClient} persistOptions={{ persister, maxAge: 1000 * 60 * 60 * 8 }}>
      <TooltipProvider>
        <Toaster />
        <Sonner />
