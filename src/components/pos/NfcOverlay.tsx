...
export const NfcOverlay = ({ status, onCancel }: NfcOverlayProps) => {
  ...
  const label = isWriting ? 'Houd bandje tegen scanner om te schrijven...' : 'Houd bandje tegen scanner...';
  ...
  return (
    <div className="fixed inset-0 z-[999] flex flex-col items-center justify-center bg-black/80 backdrop-blur-sm">
      ...
      <span
        className="mt-6 text-2xl font-extrabold uppercase tracking-[0.2em] animate-[nfcPulse_3s_ease-in-out_infinite] text-center px-4"
        style={{ color: '#00cc13' }}
      >
        {label}
      </span>
